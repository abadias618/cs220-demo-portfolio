        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div className="text-center md:text-left">
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/button" className="text-gray-300 hover:text-blue-400 transition-colors duration-300">Button Demo</a></li>
              <li><a href="#" className="text-gray-300 hover:text-blue-400 transition-colors duration-300">Projects</a></li>
          ...
          <div className="text-center md:text-left">
            ...
            <div className="flex justify-center md:justify-start space-x-4">
              ...
              <a 
                href="#" 
                className="w-10 h-10 bg-gray-700 rounded-full flex items-center justify-center hover:bg-blue-500 transform hover:scale-110 transition-all duration-300 group"
                aria-label="GitHub"
              >
              ...
              <a 
                href="#" 
                className="w-10 h-10 bg-gray-700 rounded-full flex items-center justify-center hover:bg-blue-600 transform hover:scale-110 transition-all duration-300 group"
                aria-label="LinkedIn"
              >
                <svg className="w-5 h-5 text-white group-hover:animate-pulse" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a 
                href="#" 
                className="w-10 h-10 bg-gray-700 rounded-full flex items-center justify-center hover:bg-blue-400 transform hover:scale-110 transition-all duration-300 group"
                aria-label="Twitter"
              >
                <svg className="w-5 h-5 text-white group-hover:animate-pulse" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a 
                ...
                className="w-10 h-10 bg-gray-700 rounded-full flex items-center justify-center hover:bg-red-500 transform hover:scale-110 transition-all duration-300 group"
                aria-label="Email"
              >
                <svg className="w-5 h-5 text-white group-hover:animate-pulse" fill="currentColor" viewBox="0 0 24 24">
